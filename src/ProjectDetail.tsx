    ...
    <div className="pt-16 relative overflow-hidden">
      ...
      <div className="project-detail-content">
        <div className="mb-8">
          <Link to="/projects" className="inline-flex items-center text-blue-600 hover:text-blue-800 transition-colors">
            <ArrowLeft size={16} className="mr-2" /> {t('projectDetail.backToProjects')}
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {project.date && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.1 }}
              className="bg-slate-50 p-4 rounded-lg flex items-start premium-card"
            >
              <div className="bg-blue-100 p-2 rounded-lg text-blue-600 mr-3">
                <Calendar size={20} />
              </div>
              <div>
                <h3 className="text-sm font-medium text-slate-500">{t('projectDetail.period')}</h3>
          ...
          {project.client && (
            ...
            >
              ...
              <div>
                <h3 className="text-sm font-medium text-slate-500">{t('projectDetail.client')}</h3>
          ...
          {project.role && (
            ...
            >
              ...
              <div>
                <h3 className="text-sm font-medium text-slate-500">{t('projectDetail.role')}</h3>
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-2xl font-bold mb-4">{t('projectDetail.description')}</h2>
          ...
          {project.link && (
            ...
            >
              {t('projects.viewDetails')} <ExternalLink size={16} className="ml-1" />
            </a>
          )}
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {project.challenges && (
            ...
            >
              <h2 className="text-2xl font-bold mb-4">{t('projectDetail.challenges')}</h2>
          ...
          {project.solutions && (
            ...
            >
              <h2 className="text-2xl font-bold mb-4">{t('projectDetail.solutions')}</h2>
              <ul className="space-y-2">
        ...
        {project.results && (
          ...
          >
            ...
            <div className="bg-slate-50 p-6 rounded-lg premium-card">
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-blue-600 to-violet-600 text-white p-8 rounded-lg text-center relative overflow-hidden"
        >
          <div className="relative z-10">
            <h2 className="text-2xl font-bold mb-4">{t('projectDetail.similarProject')}</h2>
            <p className="text-blue-100 mb-6">
              {t('projectDetail.helpDesc')}
            </p>
          ...
          {/* Decorative elements */}
          <motion.div 
            className="absolute -right-10 -top-10 w-40 h-40 bg-blue-500/30 rounded-full blur-3xl"
            animate={{ 
              scale: [1, 1.2, 1],
              opacity: [0.3, 0.5, 0.3]
            }}
          ...
          />
          <motion.div 
            className="absolute -left-10 -bottom-10 w-40 h-40 bg-violet-500/30 rounded-full blur-3xl"
            animate={{ 
              scale: [1, 1.2, 1],
              opacity: [0.3, 0.5, 0.3]
            }}
      ...
      <section className="py-16 bg-slate-50 relative">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle
            title={t('projectDetail.moreProjects')}
            subtitle={t('about.projectsDesc')}
            center={true}
          />
